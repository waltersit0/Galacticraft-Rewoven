 ...
 */
public class ForceFieldContainer extends MachineContainer<ForceFieldBlockEntity> {

    public static final ContainerFactory<Container> FACTORY = createFactory(ForceFieldBlockEntity.class, ForceFieldContainer::new);
    ...
    public ForceFieldContainer(int syncId, PlayerEntity playerEntity, ForceFieldBlockEntity blockEntity) {
        ...
        this.inventory = new InventoryFixedWrapper(blockEntity.getInventory()) {
            ...
            public boolean canPlayerUseInv(PlayerEntity player) {
                return ForceFieldContainer.this.canUse(player);
            }
        };
        // Energy slot
    ...
    public void setProperties(int index, int value) {
        ...
        blockEntity.status = ForceFieldStatus.values()[status.get()];
    }
}
